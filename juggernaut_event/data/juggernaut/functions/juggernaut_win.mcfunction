tellraw @a ["",{"text":"[CROWN] JUGGERNAUT WINS!","color":"red","bold":true}]
tellraw @a ["",{"text":"The Juggernaut eliminated everyone!","color":"gold"}]
tellraw @a ["",{"text":"[SWORD] Total kills: ","color":"gold"},{"score":{"name":"@a[tag=juggernaut]","objective":"jg_kills"},"color":"red","bold":true}]

playsound minecraft:music_disc.ward master @a ~ ~ ~ 1 1
playsound minecraft:entity.warden.heartbeat master @a ~ ~ ~ 1 0.5

title @a title {"text":"[CROWN] VICTORY","color":"red","bold":true}
